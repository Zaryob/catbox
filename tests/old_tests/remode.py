...
def run_tests():
    ...
    assert '/var/tmp/hello.txt' in list(ret.ownerships.keys()), "Chown: owner change was not trapped"
    ...
    assert '/var/tmp/hello.txt' in list(ret.modes.keys()), "Chmod: mode change was not trapped"
